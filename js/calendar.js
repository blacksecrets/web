...
<div>
  ...
  <a class="bit-widget-initializer"
	...
	data-text-color="rgba(208,2,27,1)"
	...
	data-event-ticket-cta-bg-color="rgba(189,16,224,1)"
	data-follow-section-position="top"
	data-follow-section-alignment="left"
	data-follow-section-header-text="Get tour updates!"
	data-follow-section-cta-text="Follow us!"
	data-follow-section-cta-icon="true"
	data-follow-section-cta-text-color="rgba(0,0,0,1)"
	data-follow-section-cta-bg-color="rgba(189,16,224,1)"
	data-play-my-city-position="bottom"
	data-play-my-city-alignment="left"
	data-play-my-city-header-text="Tell us where you want us to play!"
	data-play-my-city-cta-text="Where??"
	data-play-my-city-cta-icon="true"
	data-play-my-city-cta-text-color="rgba(0,0,0,1)"
	data-play-my-city-cta-bg-color="rgba(189,16,224,1)"
	data-play-my-city-cta-border-radius="10px"
	
	data-app-id="8c8cfd4dd08e15fcb7d6441b48d3081d"
	data-bit-logo-position="topRight"
	data-bit-logo-color="rgba(208,2,27,1)"
